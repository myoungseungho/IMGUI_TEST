...
{
private:
	CUI_PlayerEquipSlot_BackGround(LPDIRECT3DDEVICE9 pGraphic_Device); /* 원형생성 시 */
	CUI_PlayerEquipSlot_BackGround(const CUI_PlayerEquipSlot_BackGround& Prototype); /* 사본생성 시 */
