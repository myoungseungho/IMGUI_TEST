...
{
	m_pAnimCom->Add_Animator(LEVEL_STATIC, TEXT("Prototype_Component_AnimTexture_RockBreakable_Idle"), TEXT("AnimTexture_RockBreakable_Idle"));
	m_pAnimCom->Add_Animator(LEVEL_STATIC, TEXT("Prototype_Component_AnimTexture_RockBreakable_Die"), TEXT("AnimTexture_RockBreakable_MDie"));
